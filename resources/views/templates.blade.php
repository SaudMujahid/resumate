                ...
                <div class="bg-[rgba(217,182,255,0.61)] rounded-2xl p-8 h-[320px] flex flex-col justify-between">
                    ...
                    <div>
                        ...
                        <a href="{{ url('/resume/create') }}"
                           class="inline-block bg-[rgba(195,106,255,0.86)] hover:bg-[rgba(195,106,255,1)] rounded-2xl px-8 py-3 transition-all duration-300">
            ...
            <div class="relative">
                <div class="bg-[#FCE3E3] rounded-2xl p-8 h-[320px] flex flex-col justify-between">
                    ...
                    <div>
                        ...
                        <!-- Use Template Button -->
                        <a href="{{ url('/resume/create') }}"
                           class="inline-block bg-[rgba(255,107,139,0.79)] hover:bg-[rgba(255,107,139,1)] rounded-2xl px-8 py-3 transition-all duration-300">
                            <span class="font-['Inter'] font-bold text-[20px] leading-[24px] text-[#FFFFFF]">Use Template</span>
                        </a>
                    </div>
                </div>
